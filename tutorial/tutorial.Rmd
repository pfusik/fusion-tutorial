...
That complicated approach to implement a feature which is probaby available in all target
...
code in the target language ou have than to call the _fut_ transpiler with a `-D` option like this:
