...
That approach to implement a feature which is probaby available in all target
languages in a much more straightforward way. To use language specific
functionalities you can embed code block within the native keyword here an example for a StringUtils class which uses this approach. To create code in the target language ou have than to call the _fut_ transpiler with a -D option like this:
